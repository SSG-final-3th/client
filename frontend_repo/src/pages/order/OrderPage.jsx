      ...
      <div className="my-6">
        {isFromCart ? (
          selectedItems.map((item) => (
            <div key={item.productCode} className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center justify-between mb-4">
            <img src={state.image} alt={state.productName} className="w-20 h-20 object-cover rounded-md mr-4" />
            <div className="flex-1">
